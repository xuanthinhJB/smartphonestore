...
public class InfoActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng tony = new LatLng(10.786881, 106.671513);
        mMap.addMarker(new MarkerOptions().position(tony).title("Tony studio").snippet("Tony studio")); //.setIcon(BitmapDescriptorFactory.fromBitmap());
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(tony).zoom(20).build();
